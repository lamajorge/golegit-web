        ...
        <div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 animate-fade-up animate-delay-300">
            <a
              ...
              className="inline-flex items-center justify-center gap-2.5 bg-brand-600 hover:bg-brand-700 active:bg-brand-800 text-white font-medium px-6 py-3.5 rounded-full transition-all shadow-lg shadow-brand-600/25 hover:shadow-brand-600/35 hover:-translate-y-0.5"
            >
