        ...
        <div className="relative rounded-3xl bg-zinc-950 p-8 lg:p-10 mb-4 overflow-hidden">
          ...
          <div className="relative flex flex-col lg:flex-row lg:items-center gap-6">
            ...
            <div className="flex-1">
              <h3 className="text-xl font-bold text-white mb-2">Construido por abogados</h3>
              <p className="text-white/70 leading-relaxed">
                GoLegit fue diseñado por abogados especializados en derecho laboral chileno. Las plantillas cumplen
